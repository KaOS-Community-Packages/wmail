...
license=('MIT')
source=("https://github.com/Thomas101/wmail/releases/download/v${pkgver}/WMail_1_3_1_linux64.zip" "wmail.png" "wmail.desktop")
depends=("gtk2" "gconf" "nss" "libnotify" "alsa-lib")
options=(!strip)
md5sums=('0a309a0342fa7d2685dbffb62b8c48ad'
         '2da07d7b2da2cddc51a9c16491acb3cd'
         '7b9a03232809da53600251b02f03969e')

package() {
	install -dm755 $pkgdir/usr/share/wmail
	cp -r WMail-linux-x64/* $pkgdir/usr/share/wmail
